...
/**
 * 
 * Payment represents the payment information received from 
 * a payment processor. Successful receipt of payment information
 * indicates whether a payment was approved or not, and thus whether
 * an Order can transition from created to paid state.
 */
...
public class Payment {
    ...
    public Payment(
            ...
            @NotEmpty @NotNull String timestamp,
            @NotEmpty @NotNull String count,
            @NotEmpty @NotNull String hash,
            String transactionId,
            // String tenderType, 
            String transactionTimestamp, 
            // String cardBrand,
            // String transactionType, String last4, String cardExpiration, 
            String authorizationCode, String authorizationMessage, 
            String requestAmount, String transactionAmount,
            ...
            // String currency, String error, String errorCode, String errorMessage, String errorMsg, 
            String orderId, String products
            // String firstLastName, String gRecaptchaResponse, String hiddenRecaptcha,
            // String hostedPaymentSignal, String callbackMethod, String expressCheckOutPayload, String description
            ) {
        super();
